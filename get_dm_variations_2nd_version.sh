...
pam --update_dm -mE $dir/mod_parfile.par $dir/*.F8T1 #pscr.zap --setnchn 8 -T -e zap.F8T1
...
python2.7 /home/abubakr/MSc_Project/lucasscripts/make_toas.py -datadir $dir -dataext F8T1 -plotres -template $dir/redo_second_loop/smoothed.prof -overwrite
