...
pam --update_dm -E $dir/Second_loop/new_parfile.par $dir/*.pscr.zap --setnchn 8 -T -e zap.F8T1
...
tail -n +2 $dir/Second_loop/J0953+0755_newtoa_caterina.tim | grep -v "C "| cut -d " " -f4 | cut -d "." -f1 | awk '{print ($1)" "($1)+1" a a"}' > strides0_cate.dat
uniq -c $dir/Second_loop/strides0_cate.dat  | awk '{ print $2" " $3" " $4 " " $5}' > strides_cate.dat

tempo2 -gr dm -t $dir/Second_loop/strides_cate.dat -npsr 1 -nobs 390000 -f $dir/Second_loop/J0953+0755_neweph2_caterina.par $dir/Second_loop/J0953+0755_newtoa_caterina.tim
