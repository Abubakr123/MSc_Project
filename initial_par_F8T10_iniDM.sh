...
pam --setnchn 8 --setnsub 10 $zap_files -e zap.F8T10
...
python2.7 /home/abubakr/MSc_Project/lucasscripts/make_toas.py -datadir $dir -dataext F8T10 -template smoothed.prof -overwrite
